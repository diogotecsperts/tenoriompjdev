...
const menuItems = [
  { label: "Pautas", to: "/previdenciario", icon: CalendarDays, exact: true },
];

/**
 * Shell do módulo Previdenciário v2.
 * Isolado de AppLayout (trabalhista) e do PrevidenciarioLayout antigo (v1).
 */
export function PrevLayout({ children }: Props) {
        ...
        <header className="h-14 border-b border-border bg-card flex items-center justify-between px-4 md:px-6">
          <div className="flex items-center gap-2">
            ...
            <div className="flex items-center gap-2 text-sm">
              ...
              <span className="font-semibold text-foreground">Módulo Previdenciário</span>
            </div>
          </div>
