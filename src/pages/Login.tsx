        ...
        <div className="mx-auto w-full max-w-md">
                  ...
                  <form onSubmit={handleLogin} className="space-y-4">
                    <div className="space-y-2">
                      ...
                      <div className="relative">
                        ...
                        <Input id="login-email" type="text" name="email-field" value={email} onChange={e => setEmail(e.target.value)} onFocus={() => setEmailReadOnly(false)} className="pl-10 h-11" autoComplete="new-password" readOnly={emailReadOnly} required placeholder="Digite seu ID ou email" />
                      </div>
                    ...
                    <div className="space-y-2">
                      <div className="flex items-center justify-between">
                        ...
                        <button type="button" className="text-xs text-primary hover:underline" onClick={() => toast({
                      ...
                      <div className="relative">
                        ...
                        <Input id="login-password" type={showPassword ? "text" : "password"} name="password-field" placeholder="••••••••" value={password} onChange={e => setPassword(e.target.value)} onFocus={() => setPasswordReadOnly(false)} className="pl-10 pr-10 h-11" autoComplete="new-password" readOnly={passwordReadOnly} required />
          ...
          <div className="mt-8 text-center space-y-2">
            ...
            <p className="text-xs text-muted-foreground/60">
              by{" "}
              <a href="https://tecsperts.com" target="_blank" rel="noopener noreferrer" className="hover:text-muted-foreground transition-colors">
                tecsperts
              </a>
            </p>
          </div>
